...
$obj = new Frontend();
$posts = $obj->select_post_from_post_table_by_folder_id($id);
$folder_name = $obj->folder_name_by_folder_id($id);
include 'header.php';
?>
...
<div class="container">
    <div class="row">
        <div class="col-sm-8 blog-main">
            <?php
            if($posts->num_rows == 0){
                echo "<h2>No post found in this folder";
            }else{
                echo "<h1>Showing posts from $folder_name </h1> <hr><br>";
            }
